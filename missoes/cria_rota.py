...
def rota(lir,loir,lfr,lofr):
    ...
    if direc=="ML":
        C=[L,0]
        x=np.linspace(0, L, n).tolist()
        y=np.linspace(0, d, n).tolist()
        yaw=np.linspace(0, -90, n).tolist()
        np.append(x, L)
        np.append(y, d)
        np.append(yaw, -90)
        ...
        x=np.linspace(0, -L, n).tolist()
        y=np.linspace(0, -d, n).tolist()
        yaw=np.linspace(180, 90, n).tolist()
        np.append(x, -L)
        np.append(y, -d)
        np.append(yaw, 90)
        ...
        C=[0,L]
        x=np.linspace(0, -d, n).tolist()
        y=np.linspace(0, L, n).tolist()
        yaw=np.linspace(90, 0, n).tolist()
        np.append(x, -d)
        np.append(y, L)
        np.append(yaw, 0)
        ...
        x=np.linspace(0, d, n).tolist()
        y=np.linspace(0, -L, n).tolist()
        yaw=np.linspace(270, 180, n).tolist()
        np.append(x, d)
        np.append(y, -L)
        np.append(yaw, -180)
        ...
        x=np.linspace(0, xmax, n).tolist()
        y=np.linspace(0, ymax, n).tolist()
        yaw=np.linspace(180+alpha, 90+alpha, n).tolist()
        np.append(x, xmax)
        np.append(y, ymax)
        ...
        x=np.linspace(0, xmax, n).tolist()
        y=np.linspace(0, ymax, n).tolist()
        yaw=np.linspace(alpha, alpha-90, n).tolist()
        # np.append(x, xmax)
        np.append(y, ymax)
        # np.append(yaw, 90+alpha)
        ...
        x=np.linspace(0, xmax, n).tolist()
        y=np.linspace(0, ymax, n).tolist()
        yaw=np.linspace(90+alpha, alpha, n).tolist()
        # np.append(x, xmax)
        np.append(y, ymax)
        # np.append(yaw, 90+alpha)
    ...
    plt.grid()
    #plt.savefig('rota_reta_real.png')
