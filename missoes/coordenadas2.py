...
def configura_trajetoria(pontos):
     pub = rospy.Publisher('configura_pontos', String, queue_size=10)
     rate = rospy.Rate(10) # 10hz
     while not rospy.is_shutdown():
         configuracao = str(pontos)
         rospy.loginfo(configuracao)
         pub.publish(configuracao)
         rate.sleep()
...
if __name__ == '__main__':
	...
	direc=direc=direcao_destino(lat_inicial, lon_inicial, lat_final, lon_final)
	pontos=[x,y]
