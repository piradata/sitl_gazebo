...
class YOLOff(object):
    _defaults = {
        #"caminho_modelo": '/home/fernando/src/Firmware/Tools/sitl_gazebo/databank/YOLOff_treino2trained_weights_final.h5',
        "caminho_modelo": '/home/fernando/src/Firmware/Tools/sitl_gazebo/databank/YOLOff_treino2_naviotrained_weights_final.h5',
        "caminho_ancoras": '/home/fernando/src/Firmware/Tools/sitl_gazebo/databank/YOLO/model_data/yolo_anchors.txt',
        #"caminho_classes": '/home/fernando/src/Firmware/Tools/sitl_gazebo/databank/YOLO/objetos_treino2.txt',
        "caminho_classes": '/home/fernando/src/Firmware/Tools/sitl_gazebo/databank/YOLO/objetos_treino_modelo.txt',
        "score" : 0.3,
        "iou" : 0.45,
...
def INCLUI_imagem(p_entrada):
    #Abre a imagem
    for n in range(1217):
        imagem = str('/home/gabryelcefetrj/src/Firmware/Tools/sitl_gazebo/databank/tankers/image'+str(n)+'.png')
