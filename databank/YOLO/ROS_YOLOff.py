...
tl = (63,105,714,766) #Coordenadas da tela do ROS

class YOLOff(object):
    _defaults = {
        "caminho_modelo": '/home/gabryelsr/Pictures/databank/YOLOfftrained_weights_final.h5',
        "caminho_ancoras": '/home/gabryelsr/Pictures/databank/YOLO/model_data/yolo_anchors.txt',
        "caminho_classes": '/home/gabryelsr/Pictures/databank/YOLO/objetos.txt',
        "score" : 0.3,
        "iou" : 0.45,
...
if __name__=="__main__":
    ...
    while True:
        #Lendo frames da tela
        tela = ImageGrab.grab(tl)
        tela = cv2.cvtColor(np.array(tela), cv2.COLOR_RGB2BGR)
        tela = imutils.resize(tela, height=(766-105))
        imagem = tela
        ...
        #cv2.imshow("YOLOff", r_imagem)
        #img_pil = Image.fromarray(r_imagem)
        #img_pil.show("Yoloff")
        plt.imshow(r_imagem)
        plt.show()
