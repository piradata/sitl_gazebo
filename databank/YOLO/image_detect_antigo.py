    ...
    def detect_image(self, image):
        ...
        out_boxes, out_scores, out_classes = self.sess.run(
            ...
            feed_dict={
                ...
                self.input_image_shape.ref(): [image.shape[0], image.shape[1]],#[image.size[1], image.size[0]],
                K.learning_phase(): 0
            })
...
if __name__=="__main__":
    yolo = YOLO()
    image = cv2.imread('/home/gabryelsr/Pictures/databank/tankers/image1.png', cv2.IMREAD_COLOR)
    plt.imshow(image)
    plt.show()
